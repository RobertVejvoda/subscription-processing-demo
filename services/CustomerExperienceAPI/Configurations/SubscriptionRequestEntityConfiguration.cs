...
public class SubscriptionRequestEntityConfiguration : IEntityTypeConfiguration<SubscriptionRequestEntity>
{
    public void Configure(EntityTypeBuilder<SubscriptionRequestEntity> builder)
    {
        ...
        builder.Property(p => p.CustomerId).IsUnicode(false).HasMaxLength(128);
        ...
        builder.Property(p => p.SubscriptionId).IsUnicode(false).HasMaxLength(128);
        builder.Property(p => p.SubscriptionState).IsUnicode(false).HasMaxLength(32).IsRequired();
        ...
        builder.Property(p => p.UnderwritingResultMessage).HasMaxLength(2048).IsUnicode();
